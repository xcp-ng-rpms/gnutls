...
# XCP-ng: Run XPASS tests (p11-kit-trust.sh pass in xcp-ng-dev env)
# xfail_tests="${xfail_tests} p11-kit-trust.sh"
...
%changelog
* Tue Apr 21 2026 Philippe Coval <philippe.coval@vates.tech> - 3.8.8-3.1
- Make c++ lib optional (disabled by default)
- Run p11-kit-trust.sh (passing in xcp-ng-dev env)
- Rebase on 3.8.8-3
- *** Upstream changelog ***
